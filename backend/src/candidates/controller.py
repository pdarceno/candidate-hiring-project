...
def create_candidate(candidate: models.CandidateResponse, db: DBSession, _: CurrentUser):
...
def update_candidate(candidate_id: UUID, candidate: models.CandidateResponse, db: DBSession, _: CurrentUser):
